...
//-------------------------------------------------------------
	...
	{	
		...
		$q = safe_delete("txp_category","name='$name' and type='article'"); 
...
//-------------------------------------------------------------
	...
	{	
		$name = gps('name');
		safe_delete("txp_category","name='$name' and type='link'"); 
		rebuild_tree('root', 1, 'link');
...
//-------------------------------------------------------------
	...
	{	
		$name = doSlash(gps('name'));
		$q = safe_delete("txp_category", "name='$name' and type='image'"); 
		rebuild_tree('root', 1, 'image');
